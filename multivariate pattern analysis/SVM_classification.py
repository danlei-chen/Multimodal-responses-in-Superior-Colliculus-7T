...
task1_files = glob.glob('/scratch/data/'+proj1+'/SC_warp/2_*/warped_files/*cope2.nii.gz')
task1_files = task1_files + glob.glob('/scratch/data/'+proj1+'/SC_warp/3_*/warped_files/*cope3.nii.gz')
task2_files = glob.glob('/scratch/data/'+proj2+'/SC_warp/2_*/warped_files/*cope2.nii.gz')
task2_files = task2_files + glob.glob('/scratch/data/'+proj2+'/SC_warp/3_*/warped_files/*cope3.nii.gz')
