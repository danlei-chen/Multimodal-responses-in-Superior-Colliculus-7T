...
rsync -ra $DATA/BIDS_fmriprep/fmriprep/ses-02/$SUBJ/func/${SUBJ}_task-emo3_${RUN}* /scratch/$USER/$SUBJ/$PROJNAME/BIDS_preproc/$SUBJ/func
rsync -ra $DATA/BIDS_fmriprep/fmriprep/ses-02/$SUBJ/func/${SUBJ}_task-emo3_run-*_events.tsv /scratch/$USER/$SUBJ/$PROJNAME/BIDS_preproc/$SUBJ/func
rsync -ra $DATA/BIDS_fmriprep/fmriprep/ses-02/$SUBJ/func/${SUBJ}_task-emo3_run-*_confounds.tsv /scratch/$USER/$SUBJ/$PROJNAME/BIDS_preproc/$SUBJ/func
...
rsync $SCRIPTPATH/model/$PROJNAME/{emoAvd_lvl1_model.py,emoAvd_lvl1_model_startup.sh} /scratch/$USER/$SUBJ/$PROJNAME/wrkdir/
chmod +x /scratch/$USER/$SUBJ/$PROJNAME/wrkdir/emoAvd_lvl1_model_startup.sh
cd /scratch/$USER
...
$IMAGE\
/scratch/wrkdir/emoAvd_lvl1_model_startup.sh
