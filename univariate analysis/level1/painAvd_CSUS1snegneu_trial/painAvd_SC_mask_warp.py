...
subj_list.sort()
print(subj_list)
subj_list = [i for i in subj_list if 'sub-113' in i]
...
for s in subj_list:
	...
	cope_list = glob.glob('/scratch/data/'+subj+'_task-'+'*'+run+'/model/_'+subj+'_task-'+'*'+run+'/_modelestimate0/cope*.nii.gz')
	cope_list.sort()

	data_templates={}
	for cope in cope_list:
		data_templates[subj+'_'+run+'_'+cope.split('/')[-1].split('.nii')[0]] = cope
	# data_templates = {'1_CS_decision_cope': '/scratch/data/*/cope1.nii.gz',
	# 				 '2_USneg_cope': '/scratch/data/*/cope2.nii.gz',
	#                  '3_USneu_cope': '/scratch/data/*/cope3.nii.gz',
	#                  '4_USnegVneu_cope': '/scratch/data/*/cope4.nii.gz'}data_templates={}
