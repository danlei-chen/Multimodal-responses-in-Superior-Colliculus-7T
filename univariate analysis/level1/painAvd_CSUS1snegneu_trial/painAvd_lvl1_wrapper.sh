...
rsync -ra $DATA/BIDS_fmriprep/fmriprep/ses-02/$SUBJ/func/${SUBJ}_task-pain3_${RUN}* /scratch/$USER/$SUBJ/$PROJNAME/BIDS_preproc/$SUBJ/func
rsync -ra $DATA/BIDS_fmriprep/fmriprep/ses-02/$SUBJ/func/${SUBJ}_task-pain3_run-*_events.tsv /scratch/$USER/$SUBJ/$PROJNAME/BIDS_preproc/$SUBJ/func
rsync -ra $DATA/BIDS_fmriprep/fmriprep/ses-02/$SUBJ/func/${SUBJ}_task-pain3_run-*_confounds.tsv /scratch/$USER/$SUBJ/$PROJNAME/BIDS_preproc/$SUBJ/func
