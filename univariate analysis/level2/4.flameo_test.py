...
# python /Volumes/GoogleDrive/My\ Drive/U01/AffPainTask_connectivity/analysis/univariate/level2/4.flameo_testing.py
...
smooth_list = ['smoothed3mm_masked']
warping = 'SC_warp'
# warping = 'PAG_warp'
...
for proj in proj_list:
    ...
    for smooth in smooth_list:
        ...
        for con in con_list:
            ...
            work_dir = work_dir_base+proj+'_'+smooth+''
            path_base = data_dir_base+proj+'/'+warping+'/'+'sub*'+'/'
            try:
                run_flameo(con, work_dir, path_base, group_level, smooth)
            except:
                pass
